--- 
layout: post 
title: 'Resilio Sync (ex. Bittorrent Sync): полный контроль над фотографиями' 
...
Resilio Sync (ex. Bittorrent Sync) - фундаментальный инструмент для синхронизации файлов. Кроссплатформенный клиент позволяет применить гибкую схему синхронизации. Я подготовил схему:
...
*.sync*  
При случайных удалениях, в клиенте Resilio Sync (ex. Bittorrent Sync) на всех устройствах настроено сохранение файлов в директорию `.sync/Archive`.
